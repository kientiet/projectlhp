...
class Doc_To_Vec(object):
    ...
    def initParagraph(self, sentences):
        ...
        for sentence in sentences:
            count += 1
            temp = doc2vec.LabeledSentence(words = sentence, tags = ['id' + str(count)])
            sen.append(temp)
